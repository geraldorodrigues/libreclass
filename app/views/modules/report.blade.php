    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="text-center">Sua opinião é importante para o crescimento do LibreClass CE.</p>
          <p class="text-justify">Utilize o formulário abaixo para informar um erro, sugerir melhorias ou propor novas funcionalidades.
            A mensagem será enviada para <strong>modeon.co@gmail.com</strong> e nossa equipe avaliará sua solicitação para atendê-lo o mais breve possível.</p>
