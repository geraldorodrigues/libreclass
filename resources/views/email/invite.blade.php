...
<body>
  <center>
    ...
    <p style="font-size: 16pt">Seja bem vindo ao Libreclass, {{ $data['name'] }}!</p>
  </center>
    <h4 style="font-size: 16pt"> Você foi convidado para fazer parte da rede {{ $data['institution'] }}.</h4>
