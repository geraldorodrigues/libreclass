...
if (Auth::check() == false) {
  ...
  if (Auth::user()['type'] == "I") {
    ...
    Route::post('/courses/all-courses', 'CoursesController@postAllCourses');
    Route::post('/courses/save', 'CoursesController@postSave');
    Route::post('/courses/delete', 'CoursesController@postDelete');
    Route::get('/courses/edit', 'CoursesController@getEdit');
    Route::post('/courses/edit', 'CoursesController@postEdit');
    Route::post('/courses/period', 'CoursesController@postPeriod');
    Route::post('/courses/editperiod', 'CoursesController@postEditperiod');
